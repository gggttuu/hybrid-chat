...
确认 CHAT_URL = "http://10.0.2.2:3000/index.html"（模拟器访问宿主机固定写法）

检查 AndroidManifest.xml 中 android:usesCleartextTraffic="true"
...
CHAT_URL 改为 http://电脑IP:3000/index.html

点击 Choose File 没反应

确认 MainActivity.kt 使用了包含 onShowFileChooser 的版本

若真机没有文件管理器 App，可能会提示“未找到可用的文件管理器”
